...
|-------------------------------------------------------|----------------------------|------------------------------------------------------------------------|----------------------------------------------|
| [Form](docs/components/form.md)                       | `<x-hwc::form>`            | `auto-submit`, `unsaved-changes`, `error-scroll`, `clean-query-params` | [readme](docs/components/form.md)            |
...
| [File](docs/components/file.md)                       | `<x-hwc::file>`            | `file-preserve`, `reset-files`                                         | [readme](docs/components/file.md)            |
...
| [Error Scroll](docs/controllers/error-scroll.md)               | `error-scroll`        | —               | [readme](docs/controllers/error-scroll.md)        |
| [File Preserve](docs/controllers/file-preserve.md)             | `file-preserve`       | —               | [readme](docs/controllers/file-preserve.md)       |
