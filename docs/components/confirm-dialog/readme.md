...
<x-hwc::confirm-dialog title="Submit report?" message="This will be sent to the team.">
    <x-slot:trigger>
...
The controller wraps the `trigger` slot in a click-intercept zone. When the user clicks anything inside, the click is
