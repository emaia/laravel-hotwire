...
```html
<div data-controller="form--clear-input" class="relative">
    <input
        type="text"
        name="search"
        data-form--clear-input-target="input"
        class="pr-8"
    />
    <button
        type="button"
        data-form--clear-input-target="clearButton"
...
<form data-controller="form--autosubmit">
    <div data-controller="form--clear-input" class="relative">
        <input
            ...
            name="q"
            data-form--clear-input-target="input"
            data-action="inputCleared->form--autosubmit#submit input->form--autosubmit#debouncedSubmit"
            class="pr-8"
        />
        <button
            type="button"
