...
**Identifier:** `form--checkbox-select-all`
...
```html
<div data-controller="form--checkbox-select-all">
    <label>
        <input type="checkbox" data-form--checkbox-select-all-target="checkboxAll" />
        Select all
    </label>

    <label>
        <input type="checkbox" name="ids[]" value="1" data-form--checkbox-select-all-target="checkbox" />
        Item 1
    </label>
    <label>
        <input type="checkbox" name="ids[]" value="2" data-form--checkbox-select-all-target="checkbox" />
        Item 2
    </label>
    <label>
        <input type="checkbox" name="ids[]" value="3" data-form--checkbox-select-all-target="checkbox" />
        Item 3
    </label>
</div>
```
...
```html
<div
    data-controller="form--checkbox-select-all"
    data-form--checkbox-select-all-disable-indeterminate-value="true"
>
    <input type="checkbox" data-form--checkbox-select-all-target="checkboxAll" />
...
<table>
    <thead>
        <tr data-controller="form--checkbox-select-all">
            <th>
                <input type="checkbox" data-form--checkbox-select-all-target="checkboxAll" />
            </th>
            <th>Name</th>
        ...
        <tr>
            <td>
                <input
                    ...
                    name="ids[]"
                    value="1"
                    data-form--checkbox-select-all-target="checkbox"
                />
            </td>
            <td>Alice</td>
        </tr>
