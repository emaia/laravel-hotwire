...
| Action | Description |
|--------|-------------|
| `frame--polling#refresh` | Forces an immediate refresh and schedules the next one |

## Basic usage

```html
<div
    data-controller="frame--polling"
    data-frame--polling-frame-value="notifications"
    data-frame--polling-timeout-value="10000"
>
...
<div
    data-controller="frame--polling"
    data-frame--polling-frame-value="feed"
    data-frame--polling-enabled-value="true"
>
    <button data-action="frame--polling#refresh">
        Refresh now
    </button>
...
<div
    data-controller="frame--polling"
    data-frame--polling-frame-value="stats"
    data-frame--polling-timeout-value="30000"
>
...
<div
    data-controller="frame--polling"
    data-frame--polling-frame-value="activity"
    data-frame--polling-timeout-value="5000"
>
