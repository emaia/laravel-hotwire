...
**Identifier:** `utils--animated-number`
...
```html
<span
    data-controller="utils--animated-number"
    data-utils--animated-number-start-value="0"
    data-utils--animated-number-end-value="1500"
    data-utils--animated-number-duration-value="1000"
>
    1500
</span>
```
...
<span
    data-controller="utils--animated-number"
    data-utils--animated-number-start-value="0"
    data-utils--animated-number-end-value="42000"
    data-utils--animated-number-duration-value="1500"
    data-utils--animated-number-lazy-value="true"
>
    42000
</span>
```
...
<span
    data-controller="utils--animated-number"
    data-utils--animated-number-start-value="0"
    data-utils--animated-number-end-value="99"
    data-utils--animated-number-duration-value="800"
    data-utils--animated-number-lazy-value="true"
    data-utils--animated-number-lazy-threshold-value="0.5"
    data-utils--animated-number-lazy-root-margin-value="-100px"
>
    99
</span>
```
    ...
    <div>
        <p class="text-4xl font-bold">
            <span
                data-controller="utils--animated-number"
                data-utils--animated-number-start-value="0"
                data-utils--animated-number-end-value="12000"
                data-utils--animated-number-duration-value="1200"
                data-utils--animated-number-lazy-value="true"
            >12000</span>+
        </p>
        <p>Users</p>
    ...
    <div>
        <p class="text-4xl font-bold">
            <span
                data-controller="utils--animated-number"
                data-utils--animated-number-start-value="0"
                data-utils--animated-number-end-value="350"
                data-utils--animated-number-duration-value="1000"
                data-utils--animated-number-lazy-value="true"
            >350</span>
        </p>
