...
return [
    'foundation' => [
        'properties' => [
            ...
            '--foreground' => 'themed',
            '--card' => 'themed',
            '--card-foreground' => 'themed',
            '--popover' => 'themed',
            '--popover-foreground' => 'themed',
            '--primary' => 'themed',
            '--primary-foreground' => 'themed',
            '--secondary' => 'themed',
            '--secondary-foreground' => 'themed',
            '--muted' => 'themed',
            '--muted-foreground' => 'themed',
            '--accent' => 'themed',
            '--accent-foreground' => 'themed',
            '--destructive' => 'themed',
            '--destructive-foreground' => 'themed',
            '--border' => 'themed',
            '--backdrop' => 'themed',
            '--input' => 'themed',
            '--ring' => 'themed',
            '--sidebar' => 'themed',
            '--sidebar-foreground' => 'themed',
            '--sidebar-primary' => 'themed',
            '--sidebar-primary-foreground' => 'themed',
            '--sidebar-accent' => 'themed',
            '--sidebar-accent-foreground' => 'themed',
            '--sidebar-border' => 'themed',
            '--sidebar-ring' => 'themed',
            '--radius' => 'global',
        ],
        'aliases' => [
