...
final class ComponentAliases
{
    ...
    public static function subComponents(): array
    {
        return [
            ...
            'meta.prefetch' => Components\Meta\Prefetch::class,
            'meta.refresh' => Components\Meta\Refresh::class,
            'meta.cache' => Components\Meta\Cache::class,
            'meta.visit-control' => Components\Meta\VisitControl::class,
            'meta.root' => Components\Meta\Root::class,
            'meta.view-transition' => Components\Meta\ViewTransition::class,
            'meta.csrf' => Components\Meta\Csrf::class,
            'meta.color-scheme' => Components\Meta\ColorScheme::class,
            'modal.trigger' => Components\Modal\Trigger::class,
            ...
            'modal.close' => Components\Modal\Close::class,
            ...
            'alert.icon' => Components\Alert\Icon::class,
            'alert.title' => Components\Alert\Title::class,
            'attachment.action' => Components\Attachment\Action::class,
            'attachment.actions' => Components\Attachment\Actions::class,
            'attachment.content' => Components\Attachment\Content::class,
            'attachment.description' => Components\Attachment\Description::class,
            'attachment.group' => Components\Attachment\Group::class,
            'attachment.media' => Components\Attachment\Media::class,
            'attachment.title' => Components\Attachment\Title::class,
            'attachment.trigger' => Components\Attachment\Trigger::class,
            ...
            'dropdown.trigger-icon' => Components\Dropdown\TriggerIcon::class,
            ...
            'side-panel.panel' => Components\SidePanel\Panel::class,
            'side-panel.trigger' => Components\SidePanel\Trigger::class,
            'side-panel.inset' => Components\SidePanel\Inset::class,
