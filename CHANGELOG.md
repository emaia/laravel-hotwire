...
### Video embeds and regenerable CSS bundles

This release adds server-rendered video embeds and safe selective-preset regeneration, with clearer diagnostics and fixes for short-tag compilation and collapsed Sidebars.

#### Server-rendered Video Embed

- Render known YouTube and Vimeo URLs without JavaScript, with a safe fallback link for unsupported providers.
- Configure responsive ratio, loading strategy, accessible title and YouTube privacy mode.
- Keep the standalone OEmbed controller for editor-generated HTML and application-owned styling.

See [Video Embed](https://github.com/emaia/laravel-hotwire/blob/0.81.0/docs/components/video-embed.md) and the [upgrade guide](https://github.com/emaia/laravel-hotwire/blob/0.81.0/docs/upgrade.md#video-embed-owns-direct-video-urls).

#### Regenerable selective preset bundles

- Replay a recorded component selection with `hotwire:bundle-preset --from`.
- Use component-only v2 plans and normalized hashes so `hotwire:check --fix` can regenerate untouched package drift safely.
- Preserve application edits, report focused diffs and provide actionable recovery paths for invalid plans or removed presets.

See [Artisan commands](https://github.com/emaia/laravel-hotwire/blob/0.81.0/docs/commands.md#hotwirebundle-preset), [Presets](https://github.com/emaia/laravel-hotwire/blob/0.81.0/docs/presets.md#generate-a-selective-bundle), and the [upgrade guide](https://github.com/emaia/laravel-hotwire/blob/0.81.0/docs/upgrade.md#selective-bundle-plans-are-component-only).

#### Safer compilation and UI interactions

- Compile short `hw:` component tags only in genuine Blade markup, preserving literals inside PHP strings, heredocs and component attributes.
- Point owner-required diagnostics to the attributes and public properties that can shadow component context.
- Keep invisible collapsed Sidebar group labels from intercepting menu-button clicks.

See [Sidebar](https://github.com/emaia/laravel-hotwire/blob/0.81.0/docs/components/sidebar.md) and the [upgrade guide](https://github.com/emaia/laravel-hotwire/blob/0.81.0/docs/upgrade.md).

**Full Changelog**: https://github.com/emaia/laravel-hotwire/compare/0.80.0...0.81.0
