...
```javascript
static
values = { apiUrl: String }  // camelCase in JS
```
...
export default class extends Controller {
    ...
    initialize() {
        this.outputTarget.textContent = 'Hello';  ❌ Targets
        not
        ready
    }
...
Known issue: lazy controllers may not load when navigating with Turbo if the controller wasn't on the first page
visited.
