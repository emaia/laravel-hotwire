...
it('renders a field group wrapper with semantic slot', function () {
    $view = $this->blade('<x-hwc::field-group><span>x</span></x-hwc::field-group>');
...
it('merges custom class and forwards attributes', function () {
    $view = $this->blade('<x-hwc::field-group class="max-w-sm" id="profile-fields"><span>x</span></x-hwc::field-group>');
