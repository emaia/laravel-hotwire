...
@php
    if ($hoverCardId === null) {
        throw new InvalidArgumentException('Hover Card trigger must be rendered inside a Hover Card root. If a root is present, check for an intermediate component receiving hoverCardId as an attribute or exposing it as a public property, either of which shadows the root context.');
    }
