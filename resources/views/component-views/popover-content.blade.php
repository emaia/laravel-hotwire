...
@php
    if ($popoverId === null) {
        throw new InvalidArgumentException('Popover content must be rendered inside a Popover root. If a root is present, check for an intermediate component declaring a popoverId prop, which shadows the root context.');
    }
