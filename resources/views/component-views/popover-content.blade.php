...
@php
    if ($popoverId === null) {
        throw new InvalidArgumentException('Popover content must be rendered inside a Popover root. If a root is present, check for an intermediate component receiving popoverId as an attribute or exposing it as a public property, either of which shadows the root context.');
    }
